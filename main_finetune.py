...
def get_args_parser():
    ...
    parser.add_argument('--p_focal_loss', default=False,
                        help='whether use p focal loss ')
    parser.add_argument('--sqrt_loss', default=False,
                        help='whether use sqrt loss ')
    parser.add_argument('--ep_loss', default=False,
                        help='whether use exp loss ')
    parser.add_argument('--gamma', type=float, default=2.0,
                        help='gamma value for focal loss ')
    parser.add_argument('--data_path', default='/prj/SSL/data/finetune/diatom_v/', type=str,
                        help='dataset path')
...
def main(args):
    ...
    # optimizer = torch.optim.Adan(param_groups, lr=args.lr)
